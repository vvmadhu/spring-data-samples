...
public class ContentManagementController {
	...
	public ResponseEntity<List<Content>> getContents(@RequestHeader HttpHeaders headers,
		...
		content = contentManagementService.getContent(planID);
		return new ResponseEntity<List<Content>>(content, HttpStatus.OK);
	}
	
	@ApiOperation(value = "addContents", notes = "Add content to SOAP Service", response = String.class)
	@ApiResponses({
	...
	@ApiOperation(value = "updateContents", notes = "Update content to SOAP Service", response = String.class)
	@ApiResponses({
	...
	@ApiOperation(value = "deleteContents", notes = "Update content to SOAP Service", response = String.class)
	@ApiResponses({
			@ApiResponse(code = 200, message = "Successfully updated content", response = String.class),
			@ApiResponse(code = 400, message = "Invalid Request", response = Exception.class) })
