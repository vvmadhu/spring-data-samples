package com.deltadental.coe.api.cms.sqlserver.repository;
...
import com.deltadental.coe.api.cms.sqlserver.entity.ContentEntity;

@Repository
public interface SqlServerContentRepository extends JpaRepository<ContentEntity, String> {
